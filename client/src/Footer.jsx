        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li><a href="/about1" className="text-gray-300 hover:text-red-600 transition-colors">About Us</a></li>
              <li><a href="/OfflineCourses" className="text-gray-300 hover:text-red-600 transition-colors">Courses</a></li>
              <li><a href="/InquiryForm" className="text-gray-300 hover:text-red-600 transition-colors">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start gap-2">
                ...
                <span className="text-gray-300 text-sm sm:text-base">Sipah Road

Dr. Ajit Kumar ke paas, Ramaswamy, Jaunpur</span>
              </li>
              <li className="flex items-center gap-2">
                <FaPhone className="text-red-600" />
                <span className="text-gray-300 text-sm sm:text-base">+91 9918850293</span>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
          <p className="text-gray-400 text-xs sm:text-sm mb-4 md:mb-0">
            ©  DDS  Group of Institution. All rights reserved.
          </p>
